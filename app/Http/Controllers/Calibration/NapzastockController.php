...
class NapzastockController extends Controller
{

    public function index(Request $request)
    {
        $jenis = Jenisbrg::whereraw('id in (3,21)')->get();
        return view('calibration/napzastock.index',compact('jenis'));
    }
    ...
    public function cetak(Request $request)
    {
        ...
        $stock = Inventaris::OrderBy('stock','desc')
            ...
            return view('/calibration/napzastock.cetak',compact('stock','data','request','petugas','mengetahui','gudang'));            
    } 
