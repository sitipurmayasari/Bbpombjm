...
class PetugasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/invent/petugas')->with('sukses','Data Tersimpan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/invent/petugas')->with('sukses','Data Diperbaharui');
    }
    ...
    public function delete($id)
    {
        ...
        $petugas->delete();
        return redirect('/invent/petugas')->with('sukses','Data Terhapus');
    }
}
