...
class MailsubgroupController extends Controller
{
    public function index(Request $request)
    {
        $data = Mailsubgroup::orderBy('id','desc')
                            ...
                            ->paginate('10');
        return view('arsip/mailsubgroup.index',compact('data'));
    }

    public function create()
    {
        $group = Mailgroup::all();
        return view('arsip/mailsubgroup.create',compact('group'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/arsip/mailsubgroup')->with('sukses','Data Tersimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('arsip/mailsubgroup.edit',compact('data','group'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/arsip/mailsubgroup')->with('sukses','Data Diperbaharui');
    }
}
