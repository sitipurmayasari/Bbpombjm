    ...
    <div class="col-sm-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title"> Laporan Stok Barang</h4>
                ...
                <div class="col-sm-6">
                    <div class="widget-main no-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="Laporan Fisik Kelompok Barang" readonly  class="col-xs-10 col-sm-10">
                            </div>
                        </div>
                        <br>
