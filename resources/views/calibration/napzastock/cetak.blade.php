    ...
    <div>
        ...
        <div class="col-sm-12 isi" style="text-align: center">
            <div class="col-sm-12" style="text-align: center;font-size: 18px;">
                <b>Laporan Stok Alat Gelas {{$data->nama}}</b><br>
                <b><i>Laboratorium Obat dan Nappza</i></b>
            </div><br><br>
            <div class="col-sm-12 table-responsive row" style="text-align: left">
                Tanggal Penarikan Laporan : {{tgl_indo(date('Y-m-d'))}}
                <table id="simple-table" class="table  table-bordered" style="font-size: 11px;" >
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; vertical-align:middle;">Nama Lain / Sinonim</th>
                            <th style="text-align: center; vertical-align:middle;">No Katalog</th>
