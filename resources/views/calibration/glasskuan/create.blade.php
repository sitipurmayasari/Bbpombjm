...
<div class="row">
    <form class="form-horizontal validate-form" role="form" 
         method="post" action="{{route('glasskuan.store')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="col-sm-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title"> Input Persediaan Alat gelas Kuantitatif</h4>
                ...
                <div class="col-sm-6">
                    <div class="widget-main no-padding">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  placeholder="nama lain / sinonim" 
                                        class="col-xs-10 col-sm-10 required " 
                                        name="sinonim" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{$jenis->nama}}" class="col-xs-10 col-sm-10" readonly>
                                <input type="hidden" name="jenis_barang" value="{{$jenis->id}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" value="{{$lokasi->nama}}" class="col-xs-10 col-sm-10" readonly>
                                <input type="hidden" name="lokasi" value="{{$lokasi->id}}">
                            </div>
                        </div>
