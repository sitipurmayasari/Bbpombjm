...
@section('breadcrumb')
    ...
    <li><a href="/calibration/glasskuan/stock/{{$data->inventaris_id}}"> Stok Barang</a></li>
    <li>Edit</li>
@endsection
@section('content')
...
<div class="row">
    <form class="form-horizontal validate-form" role="form" 
        method="post" action="/calibration/glasskuan/updatestok/{{$data->id}}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="col-sm-12">
