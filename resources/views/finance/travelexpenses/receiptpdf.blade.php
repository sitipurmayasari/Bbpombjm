...
<body>
    ...
    <table style="width: 100%; padding" class="kepala">
        ...
        <tr>
            <td tyle="width: 20%">Uang Sebesar</td>
            <td style="width: 40%">: <b>Rp.  &nbsp;&nbsp;&nbsp; 
                @php
            ...
            <td>
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        @endphp
                        <td style="vertical-align:top"><i> - Tujuan</i></td>
                        <td> 
                            <i>
                                @if (count($item->out->outst_destiny) == 1)
                                    @foreach ($tujuan as $key=>$kota)
                        ...
                        <td style="text-align: center;vertical-align:top;"><i>. Rp.</i></td>
                        <td style="text-align: right;vertical-align:top;"> 
                            <i>
                                @php
                                    $subtrans = $jum*$bbm; 
            ...
            <td class="isi">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td> 
                            <i>
                                @if ($dailyfee->dailywage2 == 'Y')
                                    {{number_format($dailyfee->jumdaily2)}} 
                                @else
                                    {{ '-' }} 
                                @endif
                                hari &nbsp;&nbsp;&nbsp; x &nbsp;&nbsp;&nbsp;Rp.
                        ...
                        <td style="text-align: right;"> 
                            <i>
                                @if ($dailyfee->dailywage2 == 'Y')
                                    {{number_format($dailyfee->hitdaily2)}} 
                                @else
                                    {{ '-' }} 
                                @endif
                            </i> &nbsp;
                        ...
                        <td style="text-align: right"> 
                            <i>
                                @php
                                    $subTotalHarian = $dailyfee->totdaily2;
                                    $subTotal2 +=  $subTotalHarian;
                                @endphp
                                @if ($subTotalHarian != 0)
                                    {{number_format($subTotalHarian)}} 
