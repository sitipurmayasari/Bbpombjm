                   ...
                   @endphp
                    @foreach ($indi as $key=>$row)
                        <tr>
                            ...
                            <td><input type="number" name="twI[]" value="0" step="0.1" class="col-sm-6"></td>
                            <td><input type="number" name="twII[]" value="0" step="0.1" class="col-sm-6"></td>
                            <td><input type="number" name="twIII[]" value="0" step="0.1" class="col-sm-6"></td>
                            <td><input type="number" name="twIV[]" value="0" step="0.1" class="col-sm-6"></td>
                        </tr>
                    @endforeach
               </tbody>
           </table>
