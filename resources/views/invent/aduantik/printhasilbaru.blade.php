            ...
            <tbody>
                <tr>
                    <td style="vertical-align: top; align:left; width: 30%;">
                        {{$data->barang->nama_barang}} - (Kode : {{$data->barang->kode_barang}})
                        <br><br><br>
                    </td>
                    <td style="vertical-align: top; width: 20%;">{{$data->barang->lokasi}}</td>
                    <td style="vertical-align: top; align:left;">{{$data->trouble}}</td>
                </tr>
            </tbody>
        </table>
        <br>
