...
<div class="panel panel-default table-responsive hidden-xs">
    ...
    <table class="table table-condensed table-bordered">
        ...
        <tr>
            ...
            <td>
                @if ($aduan->aduan_status != 2)
                    <select name="aduan_status"  class="form-control">
                        <option value="0" {{$aduan->aduan_status==0 ? 'selected' : ''}}>Belum diperiksa</option>
                        <option value="1" {{$aduan->aduan_status==1 ? 'selected' : ''}}>Sedang Diproses</option>
                        <option value="2" {{$aduan->aduan_status==2 ? 'selected' : ''}}>Selesai Diproses</option>
                    </select>                   
                @else
                    <input type="hidden" name="aduan_status" value="{{$aduan->aduan_status}}">Selesai Diproses
                @endif
            </td>
        </tr>
    </table>
        ...
        <div class="panel-body">
            <div class="widget-main no-padding">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="{{$aduan->barang->merk}}"
                        class="col-xs-10 col-sm-10 ">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" readonly value="{{$aduan->barang->no_seri}}"
                        class="col-xs-10 col-sm-10"  >
                    </div>
                </div>
                <div class="form-group">
