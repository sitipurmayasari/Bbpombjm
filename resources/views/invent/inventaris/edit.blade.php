...
@section('breadcrumb')
    <li>Inventaris</li>
    <li><a href="/invent/inventaris"> Data Inventaris</a></li>
    <li>Edit</li>
@endsection
@section('content')
    ...
    <div class="col-sm-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title"> Ubah Data Inventaris</h4>
            ...
            <div class="widget-body">
                <div class="col-sm-6">
                    <div class="widget-main no-padding">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" 
                            for="form-field-1"> Stok Barang
                            </label>
                            <div class="col-sm-8">
                                <input type="number"  value="{{$data->jumlah_barang}}"
                                        class="col-xs-10 col-sm-10 required " 
                                        name="jumlah_barang" />
                            </div>
                        </div>
