    ...
    <div class="col-sm-12">
            ...
            <div class="widget-body col-sm-8">
                <div class="widget-main no-padding">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" >
                            <input type="text" name="judul" class="col-xs-10 col-sm-10" value="{{$data->judul}}"
                             placeholder="masukkan judul">
                             <input type="text" name="users_id" value="{{$data->users_id}}" hidden>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" 
        ...
        <div class="form-group col-sm-12" style="text-align:center;">
            <h3>Isi Pengumuman</h3>
              <form method="post">
                <textarea class="col-xs-12 col-sm-12" name="isi">{{$data->isi}}</textarea>
      </div>
    </div>
    <div class="col-sm-12">
