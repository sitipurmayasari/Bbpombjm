                ...
                <div class="form-group col-sm-12">
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-3" style="float: left">
                           <a href="{{Route('credit_poin.create')}}"  class="btn btn-primary">Tambah Data</a>   
                        </div>
        ...
        <table id="simple-table" class="table  table-bordered table-hover">
            <thead>
               <tr>
                    ...
                    <th colspan="2" style="text-align: center">Periode Penilaian</th>
                    <th rowspan="2" style="text-align: center">Poin</th>
                    <th rowspan="2" style="text-align: center">Aksi</th>
               </tr>
               <tr>
                    <th width="20%" style="text-align: center">Dari</th>
                    <th width="20%" style="text-align: center">Sampai</th>
               </tr>
            </thead>
            <tbody>   	
...
<script>
    $().ready( function () {
        $(".delete").click(function() {
                ...
                console.log(result);
                if (result.value) {
                    window.location = "/amdk/credit_poin/delete/"+id;
                }
            });
        });
    } );
