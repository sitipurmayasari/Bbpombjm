                ...
                <div class="widget-main no-padding">
                    ...
                    <div class="form-group" id="startpoin">
                        ...
                        <div class="col-sm-9" >
                            ...
                            name="startpoin" id="darinol" value="{{$data->startpoin}}"/>&nbsp;
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" 
               ...
               <div class="col-md-12">
                    <table id="myTable" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="number" min="0" name="sa1" placeholder="0" value="{{$data->sa1}}" id="1a1" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="width: 5%"></td>
                            ...
                            <td><input type="number" min="0" name="sa2" placeholder="0" id="1a2"   value="{{$data->sa2}}" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td><input type="number" min="0" name="sb" placeholder="0" id="1b"  value="{{$data->sb}}" onkeyup=onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td><input type="number" min="0" name="sc" placeholder="0" id="1c"  value="{{$data->sc}}" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="width: 5%"></td>
                            ...
                            <td><input type="number" min="0" name="jum1" placeholder="0" readonly id="jum1" value="{{$data->jum1}}"></td>
                        </tr>
                        <tr>
                            <td>1</td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" min="0" name="da" placeholder="0" id="2a"  value="{{$data->da}}" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><b>JUMLAH UNSUR UTAMA DAN UNSUR PENUNJANG</b></td>
                            <td><input type="number" min="0" name="jumlah" placeholder="0" readonly id="jumlah" value="{{$data->jumlah}}"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><b>JUMLAH KREDIT LAMA</b></td>
                            <td><input type="number" min="0" name="jumlama" placeholder="0" readonly id="jumlama" value="{{$data->jumlama}}"></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align: right"><b>TOTAL AKUMULASI KREDIT</b></td>
                            <td><input type="number" min="0" name="total" placeholder="0" readonly id="total" value="{{$data->total}}"></td>
                        </tr>
                    </table>
               </div>
            </div>
