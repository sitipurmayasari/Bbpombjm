               ...
               <div class="col-md-12">
                    <table id="myTable" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="sa1" placeholder="0" value="0" id="1a1" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="width: 5%"></td>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="sa2" placeholder="0" id="1a2"   value="0" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="sb" placeholder="0" id="1b"  value="0" onkeyup=onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="sc" placeholder="0" id="1c"  value="0" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td style="width: 5%"></td>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="jum1" placeholder="0" readonly id="jum1"></td>
                        </tr>
                        <tr>
                            <td>1</td>
                        ...
                        <tr>
                            ...
                            <td><input type="number" step="0.0001" min="0" name="da" placeholder="0" id="2a"  value="0" onkeyup="hitung(); sum()"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><b>JUMLAH UNSUR UTAMA DAN UNSUR PENUNJANG</b></td>
                            <td><input type="number" step="0.0001" min="0" name="jumlah" placeholder="0" readonly id="jumlah"></td>
                        </tr>
                        <tr>
                            <td colspan="3"><b>JUMLAH KREDIT LAMA</b></td>
                            <td><input type="number" step="0.0001" min="0" name="jumlama" placeholder="0" readonly id="jumlama">
                                <input type="hidden" id="oldjum">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align: right"><b>TOTAL AKUMULASI KREDIT</b></td>
                            <td><input type="number" step="0.0001" min="0" name="total" placeholder="0" readonly id="total"></td>
                        </tr>
                    </table>
               </div>
            </div>
