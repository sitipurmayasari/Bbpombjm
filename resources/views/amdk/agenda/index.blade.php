                ...
                <div class="form-group col-sm-12">
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-3" style="float: left">
                           <a href="{{Route('agenda.create')}}"  class="btn btn-primary">Buat Agenda</a>   
                        </div>
        ...
        <table id="simple-table" class="table  table-bordered table-hover">
            ...
            <tbody>   	
                ...
                <tr>
                    ...
                    <td>{{$row->date_to}}</td>
                    <td>
                        <a href="/amdk/agenda/edit/{{$row->id}}" class="btn btn-warning">
...
<script>
   $().ready( function () {
        $(".delete").click(function() {
                ...
                console.log(result);
                if (result.value) {
                    window.location = "/amdk/agenda/delete/"+id;
                }
            });
        });
    } );
