...
@section('breadcrumb')
    ...
    <li>Ubah Evaluator Hasil Pelatihan</li>
@endsection
@section('content')
            ...
            <div class="widget-body">
                <fieldset>
                    <div class="form-group">
                        ...
                        for="form-field-1"> Nama Peserta
                        </label>
                        <div class="col-sm-10">
                            <input type="text" class="col-xs-10 col-sm-10 required " readonly
                                    name="nama" required value="{{$data->user->name}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            @if ($data->ketua =='N')
                                <input type="radio" value="N" name="ketua" onclick="respe();" id="kepala" checked> &nbsp; <b>Kepala Balai</b> &nbsp;
                            ...
                            @else
                                ...
                                <input type="radio" value="Y" name="ketua" onclick="respe();" id="reset" checked/> &nbsp; <b>Ketua Tim</b> &nbsp;
                            @endif
                            ...
                            <div id="ketua">
                                <select name="evaluator_id"  class="col-xs-10 col-sm-10 select2" onchange="getjab();" id="katim">
                                    ...
                                    @foreach ($tim as $item)
                                        @if ($data->evaluator_id==$item->peg->id)
                                            <option value="{{$item->peg->id}}" selected>{{$item->peg->name}} ({{$item->detail}})</option>
                                        @else
                            ...
                            <input type="hidden" name="jabasn_id" value="{{$data->jabasn_id}}" id="jabatan">
